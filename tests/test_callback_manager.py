...
class TestAddingCallbacks:
    ...
    def test_add_multiple_callbacks(self,
                                    simple_callback_manager: CallbackManager,
                                    real_simple_handlers: dict[str, CallbackManager]):
    ...
    def test_add_callback_wrong_signature(self,
                                          simple_callback_manager: CallbackManager,
                                          real_simple_handlers: dict[str, CallbackManager]):
    ...
    def test_add_callback_wrong_types(self,
                                      simple_callback_manager: CallbackManager,
                                      real_simple_handlers: dict[str, CallbackManager]):
